...
parser.add_argument('--data_root', type=str, default=None,
                    help='Dataset root. Defaults to the data_root stored in the checkpoint.')
parser.add_argument('--split', type=str, default=None,
                    help='Evaluation split txt. Defaults to val_txt stored in the checkpoint.')
parser.add_argument('--mask_suffix', type=str, default=None,
                    help='Optional mask suffix override, e.g. _pixels0 for NUAA-SIRST.')
parser.add_argument('--mllm_features_path', type=str, default=None,
                    help='Optional cached MLLM/CLIP feature path override.')
...
def main():
    ...
    if cmd_args.split:
        args.val_txt = cmd_args.split
    if cmd_args.mask_suffix is not None:
        args.mask_suffix = cmd_args.mask_suffix
    if cmd_args.mllm_features_path:
        args.mllm_features_path = cmd_args.mllm_features_path
